                ...
                touch_mode: function(){
                    ...
                    p.popup.touch_mode.make_all_img_element(index,list,function(){
                        ...
                        p.pic_scroll.scroller_elemets = p.popup_el
                                                         ...
                                                         .add(p.popup_el.find(G.get_classes('title')))
                                                         .add(p.popup_el.find(G.get_classes('image_wrap')))
                                                         .add(p.popup_el.find(G.get_classes('loading')))
                                                         .add(p.popup_el.find(G.get_classes('loading_wrap')))
                                                         .add(p.popup_el.find(G.get_classes('btn_wrap')))
                                                         .add(p.popup_el.find(G.get_classes('btn_wrap_middle')))
                                                         .add(p.popup_el.find(G.get_classes('additional_btns')))
                                                         .add(p.popup_el.find(G.get_classes('edys-gallery-bottom-btns')))
                                                         .add(p.popup_el.find(G.get_classes('content_wrap')))
                                                         .add(p.popup_el.find(G.get_classes('image_wrap_box')));
